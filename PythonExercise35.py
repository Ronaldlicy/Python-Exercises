...
# 7!! = 7 x 5 x 3 x 1 = 105 The alternating factorial of a positive number n is the sum of the consecutive factorials from n to 1, where every other factorial is multiplied by -1.
# Alternating factorial of 1:
# af(1) = 1! Alternating factorial of 2:
# af(2) = 2! + (-1)x(1!) = 2! - 1! = 2 -1 = 1 Alternating factorial of 3:
# af(3) = 3! - 2! + 1! = 6 - 2 + 1 = 2 Create a function that takes a number n and returns the difference between the alternating factorial and semifactorial of n.
# Examples
# alt_semi(1) ➞ 0
# alt_semi(2) ➞ -1
# alt_semi(3)➞ 2
